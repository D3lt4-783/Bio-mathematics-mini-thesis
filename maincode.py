...
image_data = tiff.imread('/content/C2-CON_1.2-1.tif')
path = '/content/C2-CON_1.2-1.xlsx'
...
# Now, 'sorted_frame_EC' contains the sorted Euler characteristic values for each frame and cluster.
# You can use this sorted data in your Excel creation or other operations.

# Example: Print sorted EC values for frame 7
if 7 in sorted_frame_EC:
  print(f"Sorted Euler Characteristic for Frame 7: {sorted_frame_EC[7]}")
